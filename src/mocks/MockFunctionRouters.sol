...
import { IFunctionsRouter, FunctionsResponse } from "@chainlink/contracts/src/v0.8/functions/dev/v1_X/interfaces/IFunctionsRouter.sol";
import { IFunctionsClient } from "@chainlink/contracts/src/v0.8/functions/dev/v1_X/interfaces/IFunctionsClient.sol";

contract MockFunctionRouters is IFunctionsRouter {
    /**
     * @notice  Use this function to pretend that the Dons have returned a requestId and response.
     */
    function handleOracleFulfillment(address who, bytes32 requestId, bytes memory response, bytes memory err) external {
